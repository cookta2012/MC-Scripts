...
Infusion.addRecipe("ASPECTS", <ExtraUtilities:divisionSigil>, [<xreliquary:dragon_claws>, <AWWayofTime:demonicSlate>, <HardcoreEnderExpansion:stardust>], "permutatio 32, alienis 32", <ExtraUtilities:divisionSigil>.withTag({damage: 256}), 16);
...
#For Chroma, disabled if Et Futurum is on, which it is.
...
#TH PLS
Arcane.addShaped("GOLEMBELL", <Thaumcraft:GolemBell>.withTag({display: {Name: "Golemancer's Bell"}}), "ordo 5", [[null, <ore:gemQuartz>, <ore:gemQuartz>], [null, <ore:gemQuartz>, <ore:gemQuartz>], [<ore:stickWood>, null, null]]);
